...
{
    if (ps->chunk_to_sort.size == 1 && ft_is_rev_sorted(&ps->stack_a.tail) && is_the_greatest_from_head(&ps->stack_b.tail, ps->stack_a.tail->data))
        ps->stack_a.tail->chunk = 0;
    else if (ps->chunk_to_sort.size == 2 && is_the_greatest_from_head(&ps->stack_b.tail, ps->stack_a.tail->data) && is_the_greatest_from_head(&ps->stack_b.tail, ps->stack_a.tail->prev->data))
    {
