...
int					is_value_greater_than_middle(t_stack_bdle stack, \
					int middle);
...
t_middle			*ft_midpoint(t_stack_bdle stack, t_middle \
					*actual_middle);
void				ft_split_n_element(t_stack_bdle *stack, \
...
void				check_flag_status(t_push_swap *ps, int *flg_a, \
					int *flg_b);
int					ft_can_continue(t_push_swap *ps);

/* stack_a_sorting_process */
void				ft_stack_a_sorting_process(t_push_swap *ps, int *flg_a, \
					int *flg_b);
